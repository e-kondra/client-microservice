...
public class DescriptionVariables {
    ...
    public static final String CLIENT = "Client Controller";
    public static final String BRAND = "Brand Controller";
    public static final String COMPANY_DETAILS = "Company Details Controller";
    public static final String CAR = "Car Controller";
